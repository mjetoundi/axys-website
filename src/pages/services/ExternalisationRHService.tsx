    ...
    <div className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="aspect-[4/3] rounded-2xl shadow-2xl overflow-hidden relative">
                <img
                  src="/images/Pages Services/rh-detail.jpg"
                  alt="Externalisation RH"
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
                  <UserCheck className="w-16 h-16 mx-auto mb-4 opacity-90" />
                  <p className="text-lg font-semibold text-center">Externalisation RH</p>
                  <p className="text-blue-200 text-center">Conformité & Expertise</p>
                </div>
              </div>
            </motion.div>
          </div>
      ...
      <section className="section-padding bg-neutral-light-bg noise-texture">
        <div className="container-custom">
          ...
          >
            <h2 className="text-3xl font-bold text-neutral-dark mb-4">
              Pourquoi Externaliser Vos RH avec AXYS ?
            </h2>
            <p className="text-lg text-gray-support max-w-3xl mx-auto">
              Une expertise RH reconnue et des garanties de service pour votre sérénité
            </p>
          </motion.div>
            ...
            >
              <Card className="h-full text-center">
                <div className="p-6">
                  ...
                  <div className="text-neutral-dark font-semibold mb-1">Collaborateurs</div>
                  <div className="text-sm text-gray-support">Gérés mensuellement</div>
                </div>
              </Card>
            </motion.div>
            ...
            >
              <Card className="h-full text-center">
                <div className="p-6">
                  ...
                  <div className="text-sm text-gray-support">Garantie légale</div>
                </div>
              </Card>
            </motion.div>
            ...
            >
              <Card className="h-full text-center">
                <div className="p-6">
                  ...
                  <div className="text-neutral-dark font-semibold mb-1">Délai garanti</div>
                  <div className="text-sm text-gray-support">Bulletins de paie</div>
                </div>
              </Card>
            </motion.div>
            ...
            >
              <Card className="h-full text-center">
                <div className="p-6">
                  ...
                  <div className="text-neutral-dark font-semibold mb-1">Gestionnaires RH</div>
                  <div className="text-sm text-gray-support">Diplômés et certifiés</div>
                </div>
              </Card>
            </motion.div>
          </div>
